...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rName.isEmpty()){
                    name.setError("Man!! You forgot to enter your name!");
                    return;
                }
                        ...
                        if (task.isSuccessful()){
                            ...
                            fuser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toast.makeText(RegisterActivity.this, "Please check your email to verify your account.", Toast.LENGTH_SHORT).show();
                            ...
                            user.put("password",rPassword);
                            user.put("balance",rBalance);
                            ...
                            Toast.makeText(RegisterActivity.this, "There seems to be a error!"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void showInterstitialAd() {
        if (mInterstitial != null) {
            mInterstitial.show(RegisterActivity.this);
        } else {
